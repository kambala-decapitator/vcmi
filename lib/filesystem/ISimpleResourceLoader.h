...
public:
	 ...
	 */
	virtual boost::optional<bfs::path> getResourceName(const ResourceID & resourceName) const
	{
	 ...
	 */
	virtual std::set<bfs::path> getResourceNames(const ResourceID & resourceName) const
	{
		std::set<bfs::path> result;
